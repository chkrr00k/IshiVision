...
def print_contours_bounding_rect(input, rects, bounds=None):
    ...
    for [x, y, xx, yy] in rects:
        cv2.rectangle(input, (x, y), (xx, yy), (127, 0, 0), 1)
    #actual intresting parts highlighted here
    if bounds:
        cv2.rectangle(input, bounds[:2], bounds[2:], (10, 100, 0), 1)
        cv2.line(input, ((input.shape[0]//2),0), (input.shape[0]//2, input.shape[1]), (10, 128, 0), 1)

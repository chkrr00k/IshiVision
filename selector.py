...
def score(input, cont, bounds,epsilon=1, prt=False, name=""):
...
""".format(name, input.shape, baseline, lc, la, lm, dominance, total, c, bound_avg_area, real_avg_area, median_area, len(in_bound), len(in_bound)/lm, in_bound_avg_area, out_bound_avg_area))
